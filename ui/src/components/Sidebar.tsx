    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 pointer-coarse:gap-3 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          {showStatusCards ? (
            <SidebarNavItem to="/status" label={t("nav.status")} icon={LayoutGrid} textBadge={t("common.beta")} />
          ) : null}
        ...
        <SidebarSection label={t("nav.work")} collapsible={{ open: workOpen, onOpenChange: setWorkOpen }}>
          ...
          {showCases ? (
            <SidebarNavItem to="/cases" label={t("nav.cases")} icon={Layers} textBadge={t("common.beta")} />
          ) : null}
        ...
        <SidebarSection label={t("nav.company")} collapsible={{ open: companyOpen, onOpenChange: setCompanyOpen }}>
          <SidebarNavItem to="/org" label={t("nav.organization")} icon={Network} />
