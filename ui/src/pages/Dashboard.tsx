        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-900/70 dark:text-red-100/70">
                    {t("dashboard.budgetIncidentSummary", { agents: data.budgets.pausedAgents, projects: data.budgets.pausedProjects, approvals: data.budgets.pendingApprovals })}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.metrics.agentSummary", { running: data.agents.running, paused: data.agents.paused, errors: data.agents.error })}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.metrics.taskSummary", { open: data.tasks.open, blocked: data.tasks.blocked })}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? t("dashboard.metrics.budgetUsage", { percent: data.costs.monthUtilizationPercent, budget: formatCents(data.costs.monthBudgetCents) })
