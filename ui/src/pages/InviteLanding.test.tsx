...
describe("InviteLandingPage", () => {
  ...
  it("defaults invite auth to account creation and guides existing users back to sign in", async () => {
    ...
    expect(container.textContent).toContain("You've been invited to join Verrail");
  ...
  it("turns invalid sign-in responses into a clear invite-specific message", async () => {
    ...
    expect(container.textContent).toContain(
      "That email and password did not match an existing Verrail account. Check both fields, or create an account first if you are new here.",
    );
