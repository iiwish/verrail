...
export function Artifacts() {
  ...
  const kindLabels: Record<ArtifactKindFilter, string> = {
    all: t("artifacts.all"),
    image: t("artifacts.images"),
    video: t("artifacts.videos"),
    document: t("artifacts.documents"),
    text: t("artifacts.text"),
    file: t("artifacts.files"),
  };
  const groupLabels: Record<ArtifactGroupBy, string> = {
    none: t("artifacts.groupNone"),
    task: t("artifacts.groupTask"),
    parent_task: t("artifacts.groupParentTask"),
  };
  ...
  const emptyMessage = showGroupCards
    ? searching
      ? t("artifacts.noStackMatches")
      : t("artifacts.noStacks")
    : searching
      ? t("artifacts.noMatches")
      : viewingSelectedStack
        ? t("artifacts.noStackFilterMatches")
        : kind === "all"
          ? t("artifacts.empty")
          : t("artifacts.noKind");
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                variant="outline"
                size="icon"
                aria-label={t("artifacts.groupCurrent", { group: groupLabels[groupBy] })}
                title={t("artifacts.group")}
