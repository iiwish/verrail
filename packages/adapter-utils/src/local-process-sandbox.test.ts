...
describe("local process sandbox", () => {
  ...
  it.skipIf(process.platform !== "linux")("describes every valid allowlist input when no proxy rules remain", async () => {
  ...
  it.skipIf(process.platform !== "linux")("builds a fresh-root bubblewrap command with workspace access", async () => {
  ...
  it.skipIf(process.platform !== "linux")("binds a confined absolute alias to the synchronized workspace", async () => {
  ...
  it.skipIf(process.platform !== "linux")("rejects writable out-of-tree paths without an outbound restore mapping", async () => {
  ...
  it.skipIf(process.platform !== "linux")("builds a network-only namespace without changing filesystem visibility", async () => {
  ...
  it.skipIf(process.platform !== "linux")("forwards allowed proxy targets with a deep TMPDIR and rejects other hosts", async () => {
  ...
  it.skipIf(process.platform !== "linux")("always permits trusted Paperclip control-plane URLs", async () => {
